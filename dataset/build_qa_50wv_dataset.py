"""
build_qa_50wv_dataset.py - Generate a simple, structured algorithmic Q&A dataset.
...
def main(config: QADatasetConfig):
    ...
    print("Generating Structured Q&A dataset (qa_50wv)...")
